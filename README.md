...
1. There are 80 seats in a coach of train with only 7 seats in a row and a last row of only 3
...
2. Output should be seat numbers that have been booked for the user along with the display of
all the seats and their availability status through green color for vacant seats and red color for occupied seats.
